...
public class MabBus extends Mab{
	...
	public void updateLinkUCBBus(Map<Integer, ArrayList<Double>> linkUCB){
		for (Integer ID : linkUCB.keySet()){
	...
	public void updateShadowBus(Map<Integer, ArrayList<Double>> speedUCB, Map<Integer, Double> lengthUCB){
		for (Integer ID : speedUCB.keySet()){
