"""Town06 Scenic search space for the PCLA stop-sign color-patch demo."""
...
param length = 60
param seed = 33
param export_folder = localPath('../data_logs/CARLA_06/stop_sign_patch')
...
scenario Main():
    setup:
        ego = new EgoCar with name "ego", with behavior AwaitExternalPCLA()
