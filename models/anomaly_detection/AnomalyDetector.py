...
class AnomalyDetector():
    ...
    def detect_anomaly(self, new_data):
        ...
        for method in [ThresholdAD, QuantileAD, InterQuartileRangeAD, GeneralizedESDTestAD, PersistAD, LevelShiftAD, VolatilityShiftAD, SeasonalAD, AutoregressionAD, MinClusterDetector, OutlierDetector, RegressionAD, PcaAD]:
            detector = method()
